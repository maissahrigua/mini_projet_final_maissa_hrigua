package com.maissa.songs.security;
...
public class SecurityConfig {
	...
	.requestMatchers("/showCreate","/saveSong").hasAnyAuthority("ADMIN","AGENT")
	.requestMatchers("/modifierSong","/supprimerSong").hasAuthority("ADMIN")
	...
	.anyRequest().authenticated())
	 ...
	 public InMemoryUserDetailsManager userDetailsService() {
		 ...
		 return new InMemoryUserDetailsManager(admin, userMaissa,user1);
	 }*/
}
